...
{
    var aleEightOne = new AleEightOne();
    string userInput = "";
    appLogic.GetUserInput(userInput, appLogic, recordList, aleEightOne, "Delicious");

    userInput = "";
    appLogic.GetUserInput(userInput, appLogic, recordList, aleEightOne, "Citrusy");

    recordList.Add(aleEightOne);
